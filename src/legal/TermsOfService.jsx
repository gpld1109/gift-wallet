    ...
    <div style={{ minHeight: "100vh", background: "#0a0f1e", color: "#e8eaf6", fontFamily: "'Segoe UI', Arial, sans-serif", direction: "rtl" }}>
      <div style={{ maxWidth: 680, margin: "0 auto", padding: "24px 20px 80px" }}>
        ...
        <Section title="1. הסכמה לתנאים">
          השימוש באפליקציית "ארנק הטבות" ("השירות") מהווה הסכמה מלאה לתנאי שימוש אלה ולמדיניות הפרטיות, לרבות איסוף נתוני שימוש אנונימיים לצורך שיפור המוצר (כמפורט במדיניות הפרטיות, וניתן לביטול בהגדרות). אם אינך מסכים לתנאים, אנא הימנע משימוש בשירות.
        </Section>
