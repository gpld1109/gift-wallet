  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0a0f1e", color: "#e8eaf6", fontFamily: "'Segoe UI', Arial, sans-serif", direction: "rtl" }}>
      <div style={{ maxWidth: 680, margin: "0 auto", padding: "24px 20px 80px" }}>
        ...
        <p style={{ color: "#6b7280", fontSize: 13, marginBottom: 32 }}>עודכן לאחרונה: 3 ביולי 2026</p>
        ...
        <Section title="2. איזה מידע אנו אוספים">
          <ul style={{ paddingRight: 20, lineHeight: 1.9 }}>
            ...
            <li><strong>נתוני שימוש אנונימיים:</strong> אירועי שימוש כלליים באפליקציה (אילו מסכים נצפו ואילו פעולות בוצעו), לצורך שיפור המוצר. נתונים אלה <strong>אינם כוללים</strong> את הקודים, הסכומים או תוכן הכרטיסים שלך, וניתן לבטל את איסופם בכל עת דרך מסך ההגדרות ("שיפור המוצר").</li>
          </ul>
        </Section>

        <Section title="3. כיצד אנו משתמשים במידע">
          המידע האישי שלך משמש אך ורק לצורך הפעלת השירות: שמירת הכרטיסים שלך, מעקב אחר יתרות, וסנכרון בין המכשירים שלך. <strong>אנו לא מוכרים, משכירים או חולקים את המידע האישי שלך עם צדדים שלישיים למטרות שיווקיות.</strong>
          <br /><br />
          בנוסף, אנו עשויים להפיק ולהשתמש בנתונים סטטיסטיים <strong>מצרפיים ואנונימיים</strong> (למשל: ההתפלגות הכללית של ספקים, יתרות ממוצעות או קטגוריות שימוש נפוצות) לצורך שיפור המוצר ולתובנות שוק כלליות. נתונים אלה מעובדים כך שאינם מזהים אותך אישית ואינם כוללים את הקודים או תוכן הכרטיסים.
        </Section>
