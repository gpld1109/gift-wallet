...
const EN = {
  ...
  "אימייל": "Email",
  "כל מה ששייך לך,": "Everything that's yours,",
  "במקום אחד.": "in one place.",
  "הארנק החכם שלך לגיפט קארדים, זיכויים, וקופונים דיגיטליים.": "Your smart wallet for gift cards, store credits, and digital coupons.",
  "לא מפספסים הטבות": "Never miss a perk",
  "עוקבים אחרי מה שיש לכם": "Track what you have",
  "מאובטח וסודי": "Secure & private",
  "מסודר, נגיש וזמין תמיד": "Organized, always available",
  "ברוך הבא לארנק שלך": "Welcome to your wallet",
  "כתובת אימייל": "Email address",
  "המשך לכניסה": "Continue",
  "הנתונים שלך שמורים בצורה מאובטחת": "Your data is stored securely",
  ...
  "לא מצאנו את «{q}» ברשימות שלנו": "We couldn't find \"{q}\" in our lists",
  "יכול להיות שהחנות לא מכבדת אף אחד מהכרטיסים — או שהיא פשוט לא מופיעה ברשימה שלנו. כדאי לבדוק ברשימות הרשמיות למטה.": "The store may not accept any of these cards — or it may simply be missing from our list. Worth checking the official lists below.",
  "לא מצאת? חפש ברשימות של הספקים": "Didn't find it? Search the providers' own lists",
  "אלה הרשימות הרשמיות והמעודכנות של כל ספק — לא תוצאות של החיפוש שלך.": "These are each provider's official, up-to-date lists — not results for your search.",
  ...
  "{n} משתמשים": "{n} users",
  "↻ רענן": "↻ Refresh",
  "🔒 גם כמנהל אינך יכול לראות קודים של משתמשים — הם מוצפנים במפתח האישי שלהם.": "🔒 Even as an admin you can't see anyone's codes — they're encrypted with each user's own key.",
  "הצטרף {date} · {n} כרטיסים": "Joined {date} · {n} cards",
  "חסום": "Blocked",
  "החזר ל-Free": "Move to Free",
  "בטל חסימה": "Unblock",
  "חסום משתמש": "Block user",
  "לא נמצאו משתמשים": "No users found",
  "אין לך הרשאה לאזור הזה": "You don't have access to this area",
  "שגיאה בטעינת המשתמשים": "Error loading users",
  "הפעולה נכשלה": "The action failed",
  "שודרג ל-Premium ✓": "Upgraded to Premium ✓",
  "הוחזר ל-Free ✓": "Moved to Free ✓",
  "המשתמש נחסם": "User blocked",
  "החסימה הוסרה": "User unblocked",
  "📧 שלח מייל התחברות מחדש": "📧 Resend login email",
  "📧 שולח...": "📧 Sending...",
  "מעדכן...": "Updating...",
  "מוחק...": "Deleting...",
  "מייל התחברות נשלח מחדש ✓": "Login email resent ✓",
  "🗑 מחק": "🗑 Delete",
  "מחיקת משתמש לצמיתות": "Permanently delete user",
  "פעולה זו תמחק לצמיתות את ": "This permanently deletes ",
  " ואת כל הכרטיסים והנתונים שלו. לא ניתן לבטל.": " and all their cards and data. This cannot be undone.",
  "מחק לצמיתות": "Delete permanently",
  "המחיקה נכשלה": "Deletion failed",
  "המשתמש נמחק לצמיתות": "User permanently deleted",
  "שליחת המייל נכשלה": "Failed to send the email",
  "נשלחו יותר מדי בקשות — נסה שוב בעוד דקה": "Too many requests — try again in a minute",
  "החשבון הושעה": "Account suspended",
  "הגישה לחשבון זה נחסמה. אם לדעתך מדובר בטעות, אפשר לפנות אלינו.": "Access to this account has been blocked. If you think this is a mistake, get in touch.",
  "שכחת את קוד החשיפה?": "Forgot your reveal code?",
  "הזן את סיסמת ההצפנה שלך כדי להסיר את קוד החשיפה.": "Enter your encryption password to remove the reveal code.",
  "בודק...": "Checking...",
